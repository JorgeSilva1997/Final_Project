...
public class Regist_Escalao extends AppCompatActivity {
        ...
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, url,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status) {
                                //Bloco de codigo
                                Toast.makeText(Regist_Escalao.this, "Inserido com sucesso!", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                                //Bloco de codigo
                                Toast.makeText(Regist_Escalao.this, "Erro na inserção!", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Regist_Escalao.this, error.getMessage(), Toast.LENGTH_SHORT).show();
