...
public class Convocatoria_User extends AppCompatActivity {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status) {
                                ...
                                Toast.makeText(Convocatoria_User.this, "" + status, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException ex) {
                            Toast.makeText(Convocatoria_User.this, "Erro 1!", Toast.LENGTH_SHORT).show();
                        }
                    }
                }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Convocatoria_User.this, "Erro 2!", Toast.LENGTH_SHORT).show();
                    }
                });
