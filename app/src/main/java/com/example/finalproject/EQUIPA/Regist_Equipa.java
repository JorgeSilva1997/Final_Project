...
public class Regist_Equipa extends AppCompatActivity {
    ...
    {
        String url = prefix_url + "/equipa/insert";
        ...
        JsonObjectRequest postRequest = new JsonObjectRequest(Request.Method.POST, url,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status) {
                                //Bloco de codigo
                                Toast.makeText(Regist_Equipa.this, "Inserido com sucesso!", Toast.LENGTH_SHORT).show();
                                finish();
                            } else {
                                //Bloco de codigo
                                Toast.makeText(Regist_Equipa.this, "Erro na inserção!", Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Regist_Equipa.this, error.getMessage(), Toast.LENGTH_SHORT).show();
